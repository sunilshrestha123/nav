    ...
    <div class="register-box-body">
        ...
        <form action="save" method="post">
            <div class="form-group has-feedback">
                <input type="text" class="form-control" placeholder="Full name" name="registerName"id="exampleInputPassword4">
                <span class="glyphicon glyphicon-user form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
                <input type="email" class="form-control" name="registerEmail" placeholder="Email" id="exampleInputEmail1">
